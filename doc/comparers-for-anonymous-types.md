...
Note that these overloads are in the `Nito.Comparers.Linq` namespace, and there are different NuGet packages for the [Rx](https://www.nuget.org/packages/Nito.Comparers.Rx/) and [Ix](https://www.nuget.org/packages/Nito.Comparers.Ix/) overloads.