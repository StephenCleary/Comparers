...
namespace UnitTests
{
    ...
    public class IComparerTUnitTests
    {
        ...
        public static readonly List<KeyValuePair<string, object>> ComparersExceptObject =
            Comparers.Where(x => ComparedType(x.Value as System.Collections.IComparer) != typeof(object)).ToList();
        ...
        public static readonly TheoryData<string, Type> ReflexiveData =
            Comparers
                .Select(x => (x.Key, ComparedType(x.Value as System.Collections.IComparer)))
