...
namespace Nito.Comparers.Util
{
    ...
    public static class ComparableImplementations
    {
        ...
        public static int ImplementCompareTo<T>(IComparer<T> comparer, T @this, T other) where T : IComparable<T> => comparer.Compare(@this, other);
        ...
        public static int ImplementCompareTo(System.Collections.IComparer comparer, IComparable @this, object obj) => comparer.Compare(@this, obj);
        ...
        /// <param name="this">The object doing the implementing.</param>
        public static int ImplementGetHashCode<T>(IEqualityComparer<T> equalityComparer, T @this) => equalityComparer.GetHashCode(@this);

        /// <summary>
        /// Implements <see cref="IEquatable{T}.Equals(T)"/>. Types implementing <see cref="IEquatable{T}"/> should also override <see cref="Object.Equals(Object)"/> and <see cref="Object.GetHashCode"/>.
        /// </summary>
        /// <typeparam name="T">The type of objects being compared.</typeparam>
        /// <param name="equalityComparer">The comparer.</param>
        /// <param name="this">The object doing the implementing.</param>
        /// <param name="other">The other object.</param>
        public static bool ImplementEquals<T>(IEqualityComparer<T> equalityComparer, T @this, T other) where T : IEquatable<T> => equalityComparer.Equals(@this, other);
        ...
        /// <summary>
        /// Implements <c>op_Equality</c>. Types overloading <c>op_Equality</c> should also overload <c>op_Inequality</c> and override <see cref="Object.Equals(Object)"/> and <see cref="Object.GetHashCode"/>.
        /// </summary>
        /// <typeparam name="T">The type of objects being compared.</typeparam>
        /// <param name="equalityComparer">The comparer.</param>
        ...
        public static bool ImplementOpEquality<T>(IEqualityComparer<T> equalityComparer, T left, T right) => equalityComparer.Equals(left, right);

        /// <summary>
        /// Implements <c>op_Inequality</c>. Types overloading <c>op_Inequality</c> should also overload <c>op_Equality</c> and override <see cref="Object.Equals(Object)"/> and <see cref="Object.GetHashCode"/>.
        /// </summary>
        /// <typeparam name="T">The type of objects being compared.</typeparam>
        /// <param name="equalityComparer">The comparer.</param>
        /// <param name="left">A value of type <typeparamref name="T"/> or <c>null</c>.</param>
        /// <param name="right">A value of type <typeparamref name="T"/> or <c>null</c>.</param>
        public static bool ImplementOpInequality<T>(IEqualityComparer<T> equalityComparer, T left, T right) => !equalityComparer.Equals(left, right);
        ...
        /// <param name="left">A value of type <typeparamref name="T"/> or <c>null</c>.</param>
        /// <param name="right">A value of type <typeparamref name="T"/> or <c>null</c>.</param>
        public static bool ImplementOpLessThan<T>(IComparer<T> comparer, T left, T right) => comparer.Compare(left, right) < 0;
        ...
        /// <param name="left">A value of type <typeparamref name="T"/> or <c>null</c>.</param>
        /// <param name="right">A value of type <typeparamref name="T"/> or <c>null</c>.</param>
        public static bool ImplementOpGreaterThan<T>(IComparer<T> comparer, T left, T right) => comparer.Compare(left, right) > 0;
        ...
        /// <param name="left">A value of type <typeparamref name="T"/> or <c>null</c>.</param>
        /// <param name="right">A value of type <typeparamref name="T"/> or <c>null</c>.</param>
        public static bool ImplementOpLessThanOrEqual<T>(IComparer<T> comparer, T left, T right) => comparer.Compare(left, right) <= 0;
        ...
        /// <param name="left">A value of type <typeparamref name="T"/> or <c>null</c>.</param>
        /// <param name="right">A value of type <typeparamref name="T"/> or <c>null</c>.</param>
        public static bool ImplementOpGreaterThanOrEqual<T>(IComparer<T> comparer, T left, T right) => comparer.Compare(left, right) >= 0;
    }
}
