...
namespace Nito.Comparers.Util
{
    ...
    internal static class EqualityComparerHelpers
    {
        ...
        public static bool ImplementEquals<T>(T? x, T? y, bool specialNullHandling, Func<T?, T?, bool> doEquals)
        {
            if (!specialNullHandling)
            {
                if (x == null || y == null)
        ...
        public static int ImplementGetHashCode<T>(T? obj, bool specialNullHandling, Func<T?, int> doGetHashCode)
        {
            if (!specialNullHandling)
            {
                if (obj == null)
