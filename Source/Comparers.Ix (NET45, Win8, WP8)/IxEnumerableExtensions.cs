...
namespace Comparers.Linq
{
    ...
    public static class IxEnumerableExtensions
    {
        ...
        public static TSource Max<TSource>(this IEnumerable<TSource> source, Func<CompareSource<TSource>, IFullComparer<TSource>> comparerFactory)
        {
        ...
        public static IList<TSource> MaxBy<TSource, TKey>(this IEnumerable<TSource> source, Func<TSource, TKey> keySelector, Func<CompareSource<TKey>, IFullComparer<TKey>> comparerFactory)
        {
        ...
        /// <param name="keySelector">Key selector.</param>
        /// <param name="comparerFactory">The definition of a comparer to compare keys.</param>
        public static IEnumerable<TSource> DistinctUntilChanged<TSource, TKey>(this IEnumerable<TSource> source, Func<TSource, TKey> keySelector, Func<EqualityCompareSource<TKey>, IEqualityComparer<TKey>> comparerFactory)
        {
            var comparer = comparerFactory(EqualityCompareSource.For<TKey>());
